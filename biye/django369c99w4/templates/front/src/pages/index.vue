	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px 40px","borderColor":"#ccc","alignItems":"center","color":"#666","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#fff","borderWidth":"0 0 2px","width":"100%","fontSize":"14px","lineHeight":"80px","position":"fixed","borderStyle":"solid","height":"80px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","alignItems":"center","left":"20px","background":"none","display":"flex","width":"30%","position":"absolute","float":"left","height":"80px"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"rgb(17, 19, 40)","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"18px","fontWeight":"600","height":"100%"}'>基于Django的招聘数据分析可视化系统</span>
			</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","首页总数"],"appFrontIcon":"cuIcon-goods","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除","企业性质统计","企业规模统计","学历要求分析","工作地点词云","薪资(k/月)统计","查看评论","首页总数","爬取数据"],"appFrontIcon":"cuIcon-copy","buttons":["新增","查看","修改","删除","查看评论","爬取数据"],"menu":"职位","menuJump":"列表","tableName":"zhiwei"}],"menu":"职位管理"},{"child":[{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-rank","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-attentionfavor","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-circle","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"招聘资讯","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"招聘资讯分类","tableName":"newstype"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","企业性质统计","企业规模统计","学历要求分析","工作地点词云","薪资(k/月)统计","查看评论","首页总数","爬取数据"],"appFrontIcon":"cuIcon-cardboard","buttons":["查看"],"menu":"职位","menuJump":"列表","tableName":"zhiwei"}],"menu":"职位模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","企业性质统计","企业规模统计","学历要求分析","工作地点词云","薪资(k/月)统计","查看评论","首页总数","爬取数据"],"appFrontIcon":"cuIcon-cardboard","buttons":["查看"],"menu":"职位","menuJump":"列表","tableName":"zhiwei"}],"menu":"职位模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
