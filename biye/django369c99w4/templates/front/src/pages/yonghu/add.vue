...
<div :style='{"width":"100%","padding":"30px calc((100% - 1200px)/2) 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="用户手机" prop="yonghushouji">
            <el-input v-model="ruleForm.yonghushouji" 
                placeholder="用户手机" clearable :disabled=" false  ||ro.yonghushouji"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="当前状态" prop="dangqianzhuangtai">
            <el-select v-model="ruleForm.dangqianzhuangtai" placeholder="请选择当前状态" :disabled=" false  ||ro.dangqianzhuangtai" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="研究方向" prop="yanjiufangxiang">
            <el-input v-model="ruleForm.yanjiufangxiang" 
                placeholder="研究方向" clearable :disabled=" false  ||ro.yanjiufangxiang"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="工作岗位" prop="gongzuogangwei">
            <el-input v-model="ruleForm.gongzuogangwei" 
                placeholder="工作岗位" clearable :disabled=" false  ||ro.gongzuogangwei"></el-input>
          </el-form-item>
