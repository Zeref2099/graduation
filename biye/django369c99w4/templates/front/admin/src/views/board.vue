			...
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="zhiweiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="zhiweiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"24px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 24px)"}'>
						<div id="zhiweiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"50%","padding":"0 20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}'>
				...
				<div :style='{"alignContent":"center","padding":"20px 20px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"calc(50% - 20px)","fontSize":"14px","height":"calc(40% - 20px)","order":"2"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,.1)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>职位总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{zhiweiCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="zhiweiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"25%","flexWrap":"wrap","display":"flex"}'>
				<div class="tables">
					<div :style='{"margin":"0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>职位(招聘人数TOP10)</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#5c89e6","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="jobname" label="工作职位"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="reclogo" label="公司logo">
							<template slot-scope="scope">
								<div v-if="scope.row.reclogo">
									<img v-if="scope.row.reclogo.substring(0,4)=='http'" :src="scope.row.reclogo.split(',')[0]" width="30" height="30">
									<img v-else :src="$base.url+scope.row.reclogo.split(',')[0]" width="30" height="30">
								</div>
								<div v-else>无图片</div>
							</template>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="recname" label="公司"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="recscale" label="企业规模"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="headcount" label="招聘人数"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 30px)"}'>
						<div id="zhiweiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
//统计接口1
    zhiweiChat1() {
      this.$nextTick(()=>{
        ...
        var zhiweiChart1 = echarts.init(document.getElementById("zhiweiChart1"),'macarons');
        this.$http({
...
//统计接口2
    zhiweiChat2() {
      this.$nextTick(()=>{
        ...
        var zhiweiChart2 = echarts.init(document.getElementById("zhiweiChart2"),'macarons');
        this.$http({
...
//统计接口3
    zhiweiChat3() {
      this.$nextTick(()=>{
        ...
        var zhiweiChart3 = echarts.init(document.getElementById("zhiweiChart3"),'macarons');
        this.$http({
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'zhiweiChart4');
...
//统计接口5
    zhiweiChat5() {
      this.$nextTick(()=>{
        ...
        var zhiweiChart5 = echarts.init(document.getElementById("zhiweiChart5"),'macarons');
        this.$http({
