  ...
  <div :style='{"padding":"30px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='yonghu'"  label="当前状态" prop="dangqianzhuangtai">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="研究方向" prop="yanjiufangxiang">
          <el-input v-model="ruleForm.yanjiufangxiang"               placeholder="研究方向" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="工作岗位" prop="gongzuogangwei">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.dangqianzhuangtai)&& 'yonghu'==this.flag){
        this.$message.error('当前状态不能为空');
        return
      }


      if((!this.ruleForm.yanjiufangxiang)&& 'yonghu'==this.flag){
        this.$message.error('研究方向不能为空');
        return
      }


      if((!this.ruleForm.gongzuogangwei)&& 'yonghu'==this.flag){
