	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="当前状态" prop="dangqianzhuangtai">
					<el-select :disabled="ro.dangqianzhuangtai" v-model="ruleForm.dangqianzhuangtai" placeholder="请选择当前状态" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="当前状态" prop="dangqianzhuangtai">
					<el-input v-model="ruleForm.dangqianzhuangtai"
						placeholder="当前状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="研究方向" prop="yanjiufangxiang">
					<el-input v-model="ruleForm.yanjiufangxiang" placeholder="研究方向" clearable  :readonly="ro.yanjiufangxiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="研究方向" prop="yanjiufangxiang">
					<el-input v-model="ruleForm.yanjiufangxiang" placeholder="研究方向" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="工作岗位" prop="gongzuogangwei">
					<el-input v-model="ruleForm.gongzuogangwei" placeholder="工作岗位" clearable  :readonly="ro.gongzuogangwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="工作岗位" prop="gongzuogangwei">
					<el-input v-model="ruleForm.gongzuogangwei" placeholder="工作岗位" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.dangqianzhuangtaiOptions = "学生,在职人员".split(',')
