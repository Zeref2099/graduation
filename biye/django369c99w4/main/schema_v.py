...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        # cmd = "cd /yykj/python/9999/spider13084869 && scrapy crawl "+tableName+"Spider -a databaseName=django369c99w4"
        # Windows
        cmd = "cd D:\\biye\\spider && D:\\python\\Python37\\Scripts\\scrapy.exe crawl " + tableName + "Spider -a databaseName=django369c99w4"
        os.system(cmd)
